...
export class CourseService {
  ...
  protected convertDateFromClient(course: ICourse): ICourse {
    const copy: ICourse = Object.assign({}, course, {
      createdDate: course.createdDate && course.createdDate.isValid() ? course.createdDate.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((course: ICourse) => {
        course.createdDate = course.createdDate ? moment(course.createdDate) : undefined;
      });
    }
    return res;
  }
